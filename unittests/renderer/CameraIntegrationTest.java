...
class CameraIntegrationTest {
    ...
    public void cameraRaySphereIntegration() {
        ...
        assertEquals(2, countIntersections(camera, sphere1), "The number of intersection points is incorrect");

        // TC02: Big Sphere 18 points
        Sphere sphere2 = new Sphere(new Point(0, 0, -2.5), 2.5);
        assertEquals(18, countIntersections(camera, sphere2), "The number of intersection points is incorrect");

        // TC03: Medium Sphere 10 points
        Sphere sphere3 = new Sphere(new Point(0, 0, -2), 2);
        assertEquals(10, countIntersections(camera, sphere3), "The number of intersection points is incorrect");

        // TC04: The camera is inside a big ball 9 points
        Sphere sphere4 = new Sphere(new Point(0, 0, -1), 4);
        assertEquals(9, countIntersections(camera, sphere4), "The number of intersection points is incorrect");

        // TC05: Beyond Sphere 0 points
        Sphere sphere5 = new Sphere(new Point(0, 0, 2), 1);
        assertEquals(0, countIntersections(camera, sphere5), "The number of intersection points is incorrect");
    }
    ...
    public void cameraRayPlaneIntegration() {
        ...
        assertEquals(9, countIntersections(camera, plane1), "The number of intersection points is incorrect");

        // TC02: Plane with small angle 9 points
        Plane plane2 = new Plane(new Point(0, 0, -2), new Vector(0, -0.2, 1.5));
        assertEquals(9, countIntersections(camera, plane2), "The number of intersection points is incorrect");

        // TC03: Plane parallel to lower rays 6 points
        Plane plane3 = new Plane(new Point(0, 0, -4.5), new Vector(0, 1, 1));
        assertEquals(6, countIntersections(camera, plane3), "The number of intersection points is incorrect");

        // TC04: The plane is behind the camera 0 points
        Plane plane4 = new Plane(new Point(0, 0, 3), new Vector(0, 0, 1));
        assertEquals(0, countIntersections(camera, plane4), "The number of intersection points is incorrect");
    }
    ...
    public void cameraRayTriangleIntegration() {
        ...
        assertEquals(1, countIntersections(camera, triangle1), "The number of intersection points is incorrect");
        ...
        assertEquals(2, countIntersections(camera, triangle2), "The number of intersection points is incorrect");
    }
}
