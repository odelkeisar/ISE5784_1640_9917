...
public class MPtests {
    ...
    @Test
    public void mega2Test() throws CloneNotSupportedException {
        ...
        cameraBuilder.setLocation(new Point(0, 0, 1000)).setVpDistance(1000).setVpSize(200, 200)
                .setImageWriter(new ImageWriter("mega2_image", 1000, 1000)).build().renderImage().writeToImage();
    ...
    @Test
    public void mega3Test() throws CloneNotSupportedException {
        scene.setAmbientLight(new AmbientLight(new Color(WHITE), 0.15));
        ...
        cameraBuilder.setRayTracer((new SimpleRayTracer(scene)).setAntiA()).setLocation(new Point(0, 0, 1000)).setVpDistance(1000).setVpSize(200, 200)
                .setImageWriter(new ImageWriter("mega3_image", 1000, 1000)).build().renderImage().writeToImage();
